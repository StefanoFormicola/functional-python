...
def threes(n):
    '''
    Returns list of numbers from 0 to n that contain 3.
...
def small_words(text):
    '''
    Returns list of words in input that are less 5 characters long.
...
def lengths(strings):
    '''
    Given list of strings, returns list lengths of corresponding strings.
