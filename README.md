# Functional Python [![](https://github.com/StefanoFormicola/functional-python/workflows/tests/badge.svg)](https://github.com/StefanoFormicola/functional-python/actions?query=workflow%3Atests)
